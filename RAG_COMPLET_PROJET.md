...
| Service  | Port  | URL                                                    |
|----------|-------|--------------------------------------------------------|
| Backend  | 8001  | https://cognitia-labs.preview.emergentagent.com/api |
| Frontend | 3000  | https://cognitia-labs.preview.emergentagent.com  |
...
**Test API:**
```bash
curl https://cognitia-labs.preview.emergentagent.com/api/
curl https://cognitia-labs.preview.emergentagent.com/api/admin/stats
```
