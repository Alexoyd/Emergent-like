...
| Service  | Port  | URL                                                    |
|----------|-------|--------------------------------------------------------|
| Backend  | 8001  | https://codecopilot-3.preview.emergentagent.com/api |
| Frontend | 3000  | https://codecopilot-3.preview.emergentagent.com  |
...
curl https://codecopilot-3.preview.emergentagent.com/api/admin/stats
```
