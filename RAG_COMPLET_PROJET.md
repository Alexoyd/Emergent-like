...
| Service  | Port  | URL                                                    |
|----------|-------|--------------------------------------------------------|
| Backend  | 8001  | https://detailed-rag-export.preview.emergentagent.com/api |
| Frontend | 3000  | https://detailed-rag-export.preview.emergentagent.com  |
...
**Test API:**
```bash
curl https://detailed-rag-export.preview.emergentagent.com/api/
curl https://detailed-rag-export.preview.emergentagent.com/api/admin/stats
```
