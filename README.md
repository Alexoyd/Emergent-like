...
curl -X GET https://bugfix-pipeline.preview.emergentagent.com/api/

# Create a test run
curl -X POST https://bugfix-pipeline.preview.emergentagent.com/api/runs \
...
# Check frontend
curl -I https://bugfix-pipeline.preview.emergentagent.com/
```
...
curl https://bugfix-pipeline.preview.emergentagent.com/api/
```
