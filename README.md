...
curl -X GET https://cognitia-labs.preview.emergentagent.com/api/

# Create a test run
curl -X POST https://cognitia-labs.preview.emergentagent.com/api/runs \
...
# Check frontend
curl -I https://cognitia-labs.preview.emergentagent.com/
```
