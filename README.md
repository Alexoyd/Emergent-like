...
curl -X GET https://emergent-clone-150.preview.emergentagent.com/api/

# Create a test run
curl -X POST https://emergent-clone-150.preview.emergentagent.com/api/runs \
...
# Check frontend
curl -I https://emergent-clone-150.preview.emergentagent.com/
```
...
curl https://emergent-clone-150.preview.emergentagent.com/api/
```
