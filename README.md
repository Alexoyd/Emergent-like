...
curl -X GET https://admin-workflow.preview.emergentagent.com/api/

# Create a test run
curl -X POST https://admin-workflow.preview.emergentagent.com/api/runs \
...
# Check frontend
curl -I https://admin-workflow.preview.emergentagent.com/
```
...
curl https://admin-workflow.preview.emergentagent.com/api/
```
