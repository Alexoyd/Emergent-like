...
curl -X GET https://codecopilot-3.preview.emergentagent.com/api/

# Create a test run
curl -X POST https://codecopilot-3.preview.emergentagent.com/api/runs \
...
# Check frontend
curl -I https://codecopilot-3.preview.emergentagent.com/
```
